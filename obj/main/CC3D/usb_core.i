...
void DataStageOut(void)
{
  ...
  else
  {
    ...
    else if (pEPinfo->Usb_wLength == 0)
    {
      ...
      { (*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+((uint8_t)0)*8+2)*2 + (0x40006000L))) = 0); (SaveTState = (0x0030)); };
    }
  }
}
...
uint8_t Setup0_Process(void)
{
  ...
  pBuf.b = (0x40006000L) + (uint8_t *)(((volatile uint16_t)*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+((uint8_t)0)*8+4)*2 + (0x40006000L)))) * 2);
