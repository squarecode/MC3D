...
# 9 "./src/main/blackbox/blackbox_io.c" 2
...
# 11 "./src/main/blackbox/blackbox_io.c" 2
...
# 14 "./src/main/blackbox/blackbox_io.c" 2
...
# 16 "./src/main/blackbox/blackbox_io.c" 2
...
# 18 "./src/main/blackbox/blackbox_io.c" 2
...
# 44 "./src/main/blackbox/blackbox_io.c" 2
...
# 53 "./src/main/blackbox/blackbox_io.c" 2
...
# 98 "./src/main/blackbox/blackbox_io.c"
void blackboxWrite(uint8_t value)
{
...
int blackboxPrint(const char *s)
{
    ...
    switch (masterConfig.blackbox_device) {
        ...
        break;
# 188 "./src/main/blackbox/blackbox_io.c"
        case BLACKBOX_DEVICE_SERIAL:
        default:
            pos = (uint8_t*) s;
            while (*pos) {
...
# 280 "./src/main/blackbox/blackbox_io.c"
    ...
    switch (selector) {
        ...
        break;
        case BITS_32:
# 322 "./src/main/blackbox/blackbox_io.c"
            selector2 = 0;
...
# 555 "./src/main/blackbox/blackbox_io.c"
        default:
            return 0;
    }
}
        ...
        case BLACKBOX_DEVICE_SERIAL:
            {
                ...
                blackboxPort = openSerialPort(portConfig->identifier, FUNCTION_BLACKBOX, ((void *)0), baudRates[baudRateIndex],
                    MODE_TX, portOptions);
# 602 "./src/main/blackbox/blackbox_io.c"
        ...
        case BLACKBOX_DEVICE_FLASH:
            ...
            return 1;
        break;
# 629 "./src/main/blackbox/blackbox_io.c"
        default:
            return 0;
    }
}
...
# 793 "./src/main/blackbox/blackbox_io.c"
_Bool blackboxDeviceBeginLog(void)
{
    switch (masterConfig.blackbox_device) {
...
# 813 "./src/main/blackbox/blackbox_io.c"
_Bool blackboxDeviceEndLog(_Bool retainLog)
{
    ...
    switch (masterConfig.blackbox_device) {
# 834 "./src/main/blackbox/blackbox_io.c"
        default:
            return 1;
    }
}
...
# 907 "./src/main/blackbox/blackbox_io.c"
blackboxBufferReserveStatus_e blackboxDeviceReserveBufferSpace(int32_t bytes)
{
    ...
    switch (masterConfig.blackbox_device) {
        ...
        case BLACKBOX_DEVICE_FLASH:
            ...
            return BLACKBOX_RESERVE_TEMPORARY_FAILURE;
# 950 "./src/main/blackbox/blackbox_io.c"
        default:
            return BLACKBOX_RESERVE_PERMANENT_FAILURE;
    }
}
