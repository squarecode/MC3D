...
# 31 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_lib.h"
#define __USB_LIB_H 


# 1 "./src/main/vcp/hw_config.h" 1
# 30 "./src/main/vcp/hw_config.h"
#define __HW_CONFIG_H 



# 1 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_type.h" 1
# 31 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_type.h"
#define __USB_TYPE_H 


# 1 "./src/main/vcp/usb_conf.h" 1
# 30 "./src/main/vcp/usb_conf.h"
#define __USB_CONF_H 
# 44 "./src/main/vcp/usb_conf.h"
#define EP_NUM (4)
...
#define int +0
#define long +1
# 58 "/usr/arm-none-eabi/include/sys/_intsup.h" 3 4
...
# 31 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define __USB_REGS_H 
...
# 249 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPType(bEpNum,wType) (_SetENDPOINT(bEpNum, ((_GetENDPOINT(bEpNum) & EP_T_MASK) | wType )))
# 259 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _GetEPType(bEpNum) (_GetENDPOINT(bEpNum) & EP_T_FIELD)
# 269 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPTxStatus(bEpNum,wState) { register uint16_t _wRegVal; _wRegVal = _GetENDPOINT(bEpNum) & EPTX_DTOGMASK; if((EPTX_DTOG1 & wState)!= 0) _wRegVal ^= EPTX_DTOG1; if((EPTX_DTOG2 & wState)!= 0) _wRegVal ^= EPTX_DTOG2; _SetENDPOINT(bEpNum, (_wRegVal | EP_CTR_RX|EP_CTR_TX)); }
# 289 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPRxStatus(bEpNum,wState) { register uint16_t _wRegVal; _wRegVal = _GetENDPOINT(bEpNum) & EPRX_DTOGMASK; if((EPRX_DTOG1 & wState)!= 0) _wRegVal ^= EPRX_DTOG1; if((EPRX_DTOG2 & wState)!= 0) _wRegVal ^= EPRX_DTOG2; _SetENDPOINT(bEpNum, (_wRegVal | EP_CTR_RX|EP_CTR_TX)); }
# 311 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPRxTxStatus(bEpNum,wStaterx,wStatetx) { register uint32_t _wRegVal; _wRegVal = _GetENDPOINT(bEpNum) & (EPRX_DTOGMASK |EPTX_STAT) ; if((EPRX_DTOG1 & wStaterx)!= 0) _wRegVal ^= EPRX_DTOG1; if((EPRX_DTOG2 & wStaterx)!= 0) _wRegVal ^= EPRX_DTOG2; if((EPTX_DTOG1 & wStatetx)!= 0) _wRegVal ^= EPTX_DTOG1; if((EPTX_DTOG2 & wStatetx)!= 0) _wRegVal ^= EPTX_DTOG2; _SetENDPOINT(bEpNum, _wRegVal | EP_CTR_RX|EP_CTR_TX); }
# 337 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
...
# 348 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPTxValid(bEpNum) (_SetEPTxStatus(bEpNum, EP_TX_VALID))

#define _SetEPRxValid(bEpNum) (_SetEPRxStatus(bEpNum, EP_RX_VALID))
# 359 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
...
# 371 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
...
# 383 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _Set_Status_Out(bEpNum) _SetEP_KIND(bEpNum)
#define _Clear_Status_Out(bEpNum) _ClearEP_KIND(bEpNum)
# 393 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPDoubleBuff(bEpNum) _SetEP_KIND(bEpNum)
#define _ClearEPDoubleBuff(bEpNum) _ClearEP_KIND(bEpNum)
# 403 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
...
# 415 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
...
# 427 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
...
# 464 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPTxAddr(bEpNum,wAddr) (*_pEPTxAddr(bEpNum) = ((wAddr >> 1) << 1))
#define _SetEPRxAddr(bEpNum,wAddr) (*_pEPRxAddr(bEpNum) = ((wAddr >> 1) << 1))
# 474 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _GetEPTxAddr(bEpNum) ((__IO uint16_t)*_pEPTxAddr(bEpNum))
#define _GetEPRxAddr(bEpNum) ((__IO uint16_t)*_pEPRxAddr(bEpNum))
# 485 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _BlocksOf32(dwReg,wCount,wNBlocks) { wNBlocks = wCount >> 5; if((wCount & 0x1f) == 0) wNBlocks--; *pdwReg = (uint32_t)((wNBlocks << 10) | 0x8000); }
...
#define _BlocksOf2(dwReg,wCount,wNBlocks) { wNBlocks = wCount >> 1; if((wCount & 0x1) != 0) wNBlocks++; *pdwReg = (uint32_t)(wNBlocks << 10); }
...
#define _SetEPCountRxReg(dwReg,wCount) { uint16_t wNBlocks; if(wCount > 62){_BlocksOf32(dwReg,wCount,wNBlocks);} else {_BlocksOf2(dwReg,wCount,wNBlocks);} }
...
#define _SetEPRxDblBuf0Count(bEpNum,wCount) { __IO uint32_t *pdwReg = _pEPTxCount(bEpNum); _SetEPCountRxReg(pdwReg, wCount); }
# 519 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPTxCount(bEpNum,wCount) (*_pEPTxCount(bEpNum) = wCount)
#define _SetEPRxCount(bEpNum,wCount) { __IO uint32_t *pdwReg = _pEPRxCount(bEpNum); _SetEPCountRxReg(pdwReg, wCount); }
# 531 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
...
# 542 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPDblBuf0Addr(bEpNum,wBuf0Addr) {_SetEPTxAddr(bEpNum, wBuf0Addr);}
#define _SetEPDblBuf1Addr(bEpNum,wBuf1Addr) {_SetEPRxAddr(bEpNum, wBuf1Addr);}
# 554 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPDblBuffAddr(bEpNum,wBuf0Addr,wBuf1Addr) { _SetEPDblBuf0Addr(bEpNum, wBuf0Addr); _SetEPDblBuf1Addr(bEpNum, wBuf1Addr); }
# 566 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _GetEPDblBuf0Addr(bEpNum) (_GetEPTxAddr(bEpNum))
#define _GetEPDblBuf1Addr(bEpNum) (_GetEPRxAddr(bEpNum))
# 579 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPDblBuf0Count(bEpNum,bDir,wCount) { if(bDir == EP_DBUF_OUT) {_SetEPRxDblBuf0Count(bEpNum,wCount);} else if(bDir == EP_DBUF_IN) *_pEPTxCount(bEpNum) = (uint32_t)wCount; }
# 588 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPDblBuf1Count(bEpNum,bDir,wCount) { if(bDir == EP_DBUF_OUT) {_SetEPRxCount(bEpNum,wCount);} else if(bDir == EP_DBUF_IN) *_pEPRxCount(bEpNum) = (uint32_t)wCount; }
# 597 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
#define _SetEPDblBuffCount(bEpNum,bDir,wCount) { _SetEPDblBuf0Count(bEpNum, bDir, wCount); _SetEPDblBuf1Count(bEpNum, bDir, wCount); }
# 609 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_regs.h"
...
# 30 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_def.h"
#define __USB_DEF_H 
...
# 31 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_core.h"
#define __USB_CORE_H 
...
# 31 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_init.h"
#define __USB_INIT_H 
...
# 31 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_sil.h"
#define __USB_SIL_H 
...
# 31 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_mem.h"
#define __USB_MEM_H 
...
# 31 "./lib/main/STM32_USB-FS-Device_Driver/inc/usb_int.h"
#define __USB_INT_H 
...
uint16_t GetBTABLE(void)
{
  return(((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50))));
}
...
{
  (*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8 )*2 + (0x40006000L))) = ((wAddr >> 1) << 1));
}
# 491 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPRxAddr(uint8_t bEpNum, uint16_t wAddr)
{
  (*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+4)*2 + (0x40006000L))) = ((wAddr >> 1) << 1));
}
...
{
  return(((volatile uint16_t)*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8 )*2 + (0x40006000L)))));
}
...
{
  return(((volatile uint16_t)*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+4)*2 + (0x40006000L)))));
}
# 525 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPTxCount(uint8_t bEpNum, uint16_t wCount)
{
  (*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+2)*2 + (0x40006000L))) = wCount);
}
...
{
  { volatile uint32_t *pdwReg = ((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+6)*2 + (0x40006000L))); { uint16_t wNBlocks; if(wCount > 62){{ wNBlocks = wCount >> 5; if((wCount & 0x1f) == 0) wNBlocks--; *pdwReg = (uint32_t)((wNBlocks << 10) | 0x8000); };} else {{ wNBlocks = wCount >> 1; if((wCount & 0x1) != 0) wNBlocks++; *pdwReg = (uint32_t)(wNBlocks << 10); };} }; };
}
...
{
  return(((volatile uint16_t)(*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+2)*2 + (0x40006000L)))) & 0x3ff));
}
...
{
  return(((volatile uint16_t)(*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+6)*2 + (0x40006000L)))) & 0x3ff));
}
# 584 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPDblBuffAddr(uint8_t bEpNum, uint16_t wBuf0Addr, uint16_t wBuf1Addr)
{
  { {(*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8 )*2 + (0x40006000L))) = ((wBuf0Addr >> 1) << 1));}; {(*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+4)*2 + (0x40006000L))) = ((wBuf1Addr >> 1) << 1));}; };
}
# 596 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPDblBuf0Addr(uint8_t bEpNum, uint16_t wBuf0Addr)
{
  {(*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8 )*2 + (0x40006000L))) = ((wBuf0Addr >> 1) << 1));};
}
# 608 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPDblBuf1Addr(uint8_t bEpNum, uint16_t wBuf1Addr)
{
  {(*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+4)*2 + (0x40006000L))) = ((wBuf1Addr >> 1) << 1));};
}
...
{
  { { if(bDir == EP_DBUF_OUT) {{ volatile uint32_t *pdwReg = ((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+2)*2 + (0x40006000L))); { uint16_t wNBlocks; if(wCount > 62){{ wNBlocks = wCount >> 5; if((wCount & 0x1f) == 0) wNBlocks--; *pdwReg = (uint32_t)((wNBlocks << 10) | 0x8000); };} else {{ wNBlocks = wCount >> 1; if((wCount & 0x1) != 0) wNBlocks++; *pdwReg = (uint32_t)(wNBlocks << 10); };} }; };} else if(bDir == EP_DBUF_IN) *((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+2)*2 + (0x40006000L))) = (uint32_t)wCount; }; { if(bDir == EP_DBUF_OUT) {{ volatile uint32_t *pdwReg = ((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+6)*2 + (0x40006000L))); { uint16_t wNBlocks; if(wCount > 62){{ wNBlocks = wCount >> 5; if((wCount & 0x1f) == 0) wNBlocks--; *pdwReg = (uint32_t)((wNBlocks << 10) | 0x8000); };} else {{ wNBlocks = wCount >> 1; if((wCount & 0x1) != 0) wNBlocks++; *pdwReg = (uint32_t)(wNBlocks << 10); };} }; };} else if(bDir == EP_DBUF_IN) *((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+6)*2 + (0x40006000L))) = (uint32_t)wCount; }; };
}
# 654 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPDblBuf0Count(uint8_t bEpNum, uint8_t bDir, uint16_t wCount)
{
  { if(bDir == EP_DBUF_OUT) {{ volatile uint32_t *pdwReg = ((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+2)*2 + (0x40006000L))); { uint16_t wNBlocks; if(wCount > 62){{ wNBlocks = wCount >> 5; if((wCount & 0x1f) == 0) wNBlocks--; *pdwReg = (uint32_t)((wNBlocks << 10) | 0x8000); };} else {{ wNBlocks = wCount >> 1; if((wCount & 0x1) != 0) wNBlocks++; *pdwReg = (uint32_t)(wNBlocks << 10); };} }; };} else if(bDir == EP_DBUF_IN) *((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+2)*2 + (0x40006000L))) = (uint32_t)wCount; };
}
# 666 "./lib/main/STM32_USB-FS-Device_Driver/src/usb_regs.c"
void SetEPDblBuf1Count(uint8_t bEpNum, uint8_t bDir, uint16_t wCount)
{
  { if(bDir == EP_DBUF_OUT) {{ volatile uint32_t *pdwReg = ((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+6)*2 + (0x40006000L))); { uint16_t wNBlocks; if(wCount > 62){{ wNBlocks = wCount >> 5; if((wCount & 0x1f) == 0) wNBlocks--; *pdwReg = (uint32_t)((wNBlocks << 10) | 0x8000); };} else {{ wNBlocks = wCount >> 1; if((wCount & 0x1) != 0) wNBlocks++; *pdwReg = (uint32_t)(wNBlocks << 10); };} }; };} else if(bDir == EP_DBUF_IN) *((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+6)*2 + (0x40006000L))) = (uint32_t)wCount; };
}
...
{
  if ((uint16_t)(*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+6)*2 + (0x40006000L))) & 0xFC00) != 0)
    return(EP_DBUF_OUT);
  else if (((uint16_t)(*((volatile uint32_t *)((((volatile uint16_t) *((volatile unsigned *)((0x40005C00L) + 0x50)))+bEpNum*8+2)*2 + (0x40006000L)))) & 0x03FF) != 0)
    return(EP_DBUF_IN);
  else
    return(EP_DBUF_ERR);
}
