...
# 1 "./src/main/drivers/barometer_spi_bmp280.h" 1
# 18 "./src/main/drivers/barometer_spi_bmp280.h"
       

void bmp280SpiInit(void);
_Bool bmp280ReadRegister(uint8_t reg, uint8_t length, uint8_t *data);
_Bool bmp280WriteRegister(uint8_t reg, uint8_t data);
void bmp280_spi_start_up(void);
void bmp280_spi_get_up(void);
# 32 "./src/main/drivers/barometer_bmp280.c" 2
