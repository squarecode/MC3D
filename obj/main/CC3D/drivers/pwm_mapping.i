...
# 72 "./src/main/drivers/pwm_mapping.c"
enum {
    MAP_TO_PPM_INPUT = 1,
    MAP_TO_PWM_INPUT,
    MAP_TO_MOTOR_OUTPUT,
...
# 148 "./src/main/drivers/pwm_mapping.c"
...
# 696 "./src/main/drivers/pwm_mapping.c"
...
# 778 "./src/main/drivers/pwm_mapping.c"
        ...
        if (init->useVbat && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)) && timerHardwarePtr->pin == ((uint16_t)0x0001)) {
            continue;
        }



        if (init->useRSSIADC && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)) && timerHardwarePtr->pin == ((uint16_t)0x0001)) {
            continue;
        }
...
# 819 "./src/main/drivers/pwm_mapping.c"
...
# 896 "./src/main/drivers/pwm_mapping.c"
        ...
        if (init->useParallelPWM) {
            ...
            if ((type == MAP_TO_SERVO_OUTPUT || type == MAP_TO_MOTOR_OUTPUT) && (timerHardwarePtr->tim == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)) || timerHardwarePtr->tim == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)))) {
                continue;
            }
            if (type == MAP_TO_PWM_INPUT && timerHardwarePtr->tim == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800))) {
                continue;
            }
        ...
        if (type == MAP_TO_PPM_INPUT) {
            ...
            if (init->useOneshot || isMotorBrushed(init->motorPwmRate)){
             ...
             if (timerHardwarePtr->tim == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)))
              continue;
            }
