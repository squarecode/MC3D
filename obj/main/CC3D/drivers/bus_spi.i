...
# 113 "./src/main/drivers/bus_spi.c"
    ...
    gpio.pin = ((uint16_t)0x0080) | ((uint16_t)0x0020);
    gpio.speed = Speed_50MHz;
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &gpio);


    gpio.pin = ((uint16_t)0x0040);
    gpio.mode = Mode_IN_FLOATING;
    gpioInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &gpio);



    gpio.pin = ((uint16_t)0x0010);
    ...
    SPI_Init(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), &spi);
...
# 252 "./src/main/drivers/bus_spi.c"
    gpio_config_t gpio;
...
# 423 "./src/main/drivers/bus_spi.c"
_Bool spiInit(SPI_TypeDef *instance)
{
    ...
    if (instance == ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000))) {
        initSpi1();
        return 1;
    }
