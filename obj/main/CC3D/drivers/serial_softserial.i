...
softSerial_t softSerialPorts[1];
...
serialPort_t *openSoftSerial(softSerialPortIndex_e portIndex, serialReceiveCallbackPtr callback, uint32_t baud, portOptions_t options)
{
    ...
    if (portIndex == SOFTSERIAL1) {
        softSerial->rxTimerHardware = &(timerHardware[2]);
        softSerial->txTimerHardware = &(timerHardware[1]);
    }
# 207 "./src/main/drivers/serial_softserial.c"
