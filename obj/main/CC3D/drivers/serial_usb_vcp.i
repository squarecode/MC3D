...
# 21 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 24 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 27 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 30 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 31 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 35 "./src/main/drivers/serial_usb_vcp.c" 2
...
# 36 "./src/main/drivers/serial_usb_vcp.c" 2
...
static _Bool isUsbVcpTransmitBufferEmpty(serialPort_t *instance)
{
    (void)(instance);
    return 1;
}
...
static _Bool usbVcpFlush(vcpPort_t *port)
{
    ...
    } while (txed != count && (millis() - start < 50));
...
{
    vcpPort_t *port = ( __extension__ ({ const typeof( ((vcpPort_t *)0)->port ) *__mptr = (instance); (vcpPort_t *)( (char *)__mptr - __builtin_offsetof (vcpPort_t, port) );}));
