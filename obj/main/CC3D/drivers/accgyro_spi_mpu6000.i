# 1 "./src/main/drivers/accgyro_spi_mpu6000.c"
...
# 1 "./src/main/drivers/accgyro_spi_mpu6000.c"
# 25 "./src/main/drivers/accgyro_spi_mpu6000.c"
...
# 26 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 27 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 28 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 30 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 32 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 33 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 35 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 36 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 37 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 38 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 39 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 41 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 42 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
void checkMPUDataReady(_Bool *mpuDataReadyPtr);
# 43 "./src/main/drivers/accgyro_spi_mpu6000.c" 2
...
# 44 "./src/main/drivers/accgyro_spi_mpu6000.c" 2

static void mpu6000AccAndGyroInit(void);

static _Bool mpuSpi6000InitDone = 0;
...
_Bool mpu6000WriteRegister(uint8_t reg, uint8_t data)
{
    ...
    spiTransferByte(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), reg);
    spiTransferByte(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), data);
...
{
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0010));
    spiTransferByte(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), reg | 0x80);
    spiTransfer(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), data, ((void *)0), length);
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0010));
...
void mpu6000SpiGyroInit(uint8_t lpf)
{
    ...
    spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), 128);


    mpu6000WriteRegister(0x1A, lpf);
    delayMicroseconds(1);

    spiSetDivisor(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), 2);
...
_Bool mpu6000SpiDetect(void)
{
    ...
    mpu6000WriteRegister(0x6B, 0x80);

    do {
        delay(150);

        mpu6000ReadRegister(0x75, 1, &in);
        if (in == (0x68)) {
            break;
        }
...
static void mpu6000AccAndGyroInit(void) {
    ...
    mpu6000WriteRegister(0x68, 3 | 2 | 1);
    delay(150);


    mpu6000WriteRegister(0x6B, 0x03);
    delayMicroseconds(15);


    mpu6000WriteRegister(0x6A, 0x10);
    delayMicroseconds(15);

    mpu6000WriteRegister(0x6C, 0x00);
    delayMicroseconds(15);



    mpu6000WriteRegister(0x19, gyroMPU6xxxGetDividerDrops());
    delayMicroseconds(15);


    mpu6000WriteRegister(0x1B, INV_FSR_2000DPS << 3);
    delayMicroseconds(15);


    mpu6000WriteRegister(0x1C, INV_FSR_16G << 3);
    delayMicroseconds(15);


    mpu6000WriteRegister(0x37, 0 << 7 | 0 << 6 | 0 << 5 | 1 << 4 | 0 << 3 | 0 << 2 | 0 << 1 | 0 << 0);
    delayMicroseconds(15);


    mpu6000WriteRegister(0x38, (1 << 0));
    delayMicroseconds(15);
