...
# 108 "/usr/arm-none-eabi/include/math.h" 3
...
# 150 "/usr/arm-none-eabi/include/math.h" 3
...
# 173 "/usr/arm-none-eabi/include/math.h" 3
...
# 225 "/usr/arm-none-eabi/include/math.h" 3
...
# 475 "/usr/arm-none-eabi/include/math.h" 3
...
# 519 "/usr/arm-none-eabi/include/math.h" 3
...
# 57 "/usr/arm-none-eabi/include/ctype.h" 3
...
# 84 "/usr/arm-none-eabi/include/ctype.h" 3
...
# 104 "/usr/arm-none-eabi/include/ctype.h" 3
...
typedef enum {
    ...
    TASK_COMPASS,
# 74 "./src/main/scheduler.h"
    TASK_TELEMETRY,


    TASK_LEDSTRIP,
# 88 "./src/main/scheduler.h"
    TASK_COUNT,
...
# 33 "./src/main/common/typeconversion.h"
...
typedef void (*sensorInterruptFuncPtr)(_Bool *data);
...
typedef struct rxConfig_s {
    ...
    uint8_t superExpoFactor;
    uint8_t superExpoFactorYaw;
    uint8_t superExpoYawMode;
...
void processRcStickPositions(rxConfig_t *rxConfig, throttleStatus_e throttleStatus, _Bool disarm_kill_switch);
...
# 19 "./src/main/flight/pid.h"
       

#define GYRO_I_MAX 256
#define YAW_P_LIMIT_MIN 100
#define YAW_P_LIMIT_MAX 400
...
typedef struct pidProfile_s {
    ...
    float dterm_lpf_hz;
    float yaw_lpf_hz;
    uint16_t rollPitchItermResetRate;
    uint8_t rollPitchItermResetAlways;
    uint16_t yawItermResetRate;
    uint16_t yaw_p_limit;
    uint8_t dterm_average_count;
    uint8_t dterm_differentiator;
# 93 "./src/main/flight/pid.h"
} pidProfile_t;

extern int16_t axisPID[3];
extern int32_t axisPID_P[3], axisPID_I[3], axisPID_D[3];
_Bool antiWindupProtection;
...
typedef struct profile_s {
    ...
    controlRateConfig_t controlRateProfile[3];
} profile_t;
...
typedef struct master_t {
    ...
    uint8_t use_oneshot42;
    uint8_t use_multiShot;
    ...
    adjustmentRange_t adjustmentRanges[15];
...
static const char * const mixerNames[] = {
    ...
    "ATAIL4", "CUSTOM", "CUSTOMAIRPLANE", "CUSTOMTRI", "QUADX1234", ((void *)0)
};
...
const clicmd_t cmdTable[] = {
    ...
    { "flash_erase", cliFlashErase },
    { "flash_info", cliFlashInfo },
...
# 617 "./src/main/io/serial_cli.c"
    ...
    { "yaw_p_limit", VAR_UINT16 | PROFILE_VALUE, &masterConfig.profile[0].pidProfile.yaw_p_limit, .config.minmax = { 100, 400 } },
    ...
    { "roll_rate", VAR_UINT8 | PROFILE_RATE_VALUE, &masterConfig.profile[0].controlRateProfile[0].rates[FD_ROLL], .config.minmax = { 0, 100 } },
    { "pitch_rate", VAR_UINT8 | PROFILE_RATE_VALUE, &masterConfig.profile[0].controlRateProfile[0].rates[FD_PITCH], .config.minmax = { 0, 100 } },
    { "yaw_rate", VAR_UINT8 | PROFILE_RATE_VALUE, &masterConfig.profile[0].controlRateProfile[0].rates[FD_YAW], .config.minmax = { 0, 255 } },
    { "tpa_rate", VAR_UINT8 | PROFILE_RATE_VALUE, &masterConfig.profile[0].controlRateProfile[0].dynThrPID, .config.minmax = { 0, 100} },
    { "tpa_breakpoint", VAR_UINT16 | PROFILE_RATE_VALUE, &masterConfig.profile[0].controlRateProfile[0].tpa_breakpoint, .config.minmax = { 1000, 2000} },
    ...
    { "baro_tab_size", VAR_UINT8 | MASTER_VALUE, &masterConfig.barometerConfig.baro_sample_count, .config.minmax = { 0, 48 } },
...
static void cliDump(char *cmdline)
{
    ...
    if ((dumpMask & DUMP_MASTER) || (dumpMask & DUMP_ALL)) {
        ...
        if (dumpMask & DUMP_ALL) {
            ...
            uint8_t rateCount;
            for (profileCount=0; profileCount<2;profileCount++) {
                cliDumpProfile(profileCount);
                for (rateCount=0; rateCount<3; rateCount++)
...
static void cliPrintVar(const clivalue_t *var, uint32_t full)
{
 ...
 if ((var->type & (0x30)) == PROFILE_RATE_VALUE) {
