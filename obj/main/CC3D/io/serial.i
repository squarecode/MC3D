...
static serialPortUsage_t serialPortUsageList[4];

const serialPortIdentifier_e serialPortIdentifiers[4] = {
...
serialPortConfig_t *findNextSerialPortConfig(serialPortFunction_e function)
{
    while (findSerialPortConfigState.lastIndex < 4) {
...
serialPort_t *findNextSharedSerialPort(uint16_t functionMask, serialPortFunction_e sharedWithFunction)
{
    while (findSharedSerialPortState.lastIndex < 4) {
