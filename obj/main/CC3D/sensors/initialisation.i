...
void mwDisarm(void);
# 63 "./src/main/sensors/initialisation.c" 2
...
{
# 134 "./src/main/sensors/initialisation.c"
    static const extiConfig_t cc3dMPUIntExtiConfig = {
            .gpioAPB2Peripherals = ((uint32_t)0x00000004),
            .gpioPort = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),
            .gpioPin = Pin_3,
            .exti_port_source = ((uint8_t)0x00),
            .exti_pin_source = ((uint8_t)0x03),
            .exti_line = ((uint32_t)0x00008),
...
# 259 "./src/main/sensors/initialisation.c"
...
# 278 "./src/main/sensors/initialisation.c"
            ;
        case GYRO_L3G4200D:
# 289 "./src/main/sensors/initialisation.c"
            ;

        case GYRO_MPU3050:
# 301 "./src/main/sensors/initialisation.c"
            ;

        case GYRO_L3GD20:
# 313 "./src/main/sensors/initialisation.c"
            ;
        ...
        case GYRO_MPU6500:
# 343 "./src/main/sensors/initialisation.c"
            ;
...
retry:
    ...
    switch (accHardwareToUse) {
        case ACC_DEFAULT:
            ;
        case ACC_ADXL345:
# 397 "./src/main/sensors/initialisation.c"
            ;
        case ACC_LSM303DLHC:
# 408 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6050:
# 419 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MMA8452:
# 435 "./src/main/sensors/initialisation.c"
            ;
        case ACC_BMA280:
# 446 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6000:
            ...
            ;
        case ACC_MPU6500:
# 473 "./src/main/sensors/initialisation.c"
            ;
        case ACC_FAKE:
...
static void detectBaro(baroSensor_e baroHardwareToUse)
{
    ...
    (void)(baroHardwareToUse);
# 575 "./src/main/sensors/initialisation.c"
}
...
# 629 "./src/main/sensors/initialisation.c"
retry:
    ...
    switch(magHardwareToUse) {
        ...
        case MAG_AK8975:
# 659 "./src/main/sensors/initialisation.c"
            ;

        case MAG_AK8963:
# 671 "./src/main/sensors/initialisation.c"
            ;
...
_Bool sensorsAutodetect(sensorAlignmentConfig_t *sensorAlignmentConfig, uint8_t accHardwareToUse, uint8_t magHardwareToUse, uint8_t baroHardwareToUse, int16_t magDeclinationFromConfig, uint8_t gyroLpf, uint8_t gyroSyncDenominator)
{
    ...
    gyroUpdateSampleRate(gyroLpf, gyroSyncDenominator);
    gyro.init(gyroLpf);
