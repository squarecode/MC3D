...
# 30 "./src/main/vcp/stm32_it.h"
#define __STM32_IT_H 


# 1 "./src/main/vcp/platform_config.h" 1
# 30 "./src/main/vcp/platform_config.h"
...
# 35 "./src/main/vcp/platform_config.h" 2
# 52 "./src/main/vcp/platform_config.h"
...
# 1 "./src/main/target/CC3D/target.h" 1
# 18 "./src/main/target/CC3D/target.h"
...
# 67 "./src/main/vcp/hw_config.c"
void Set_System(void)
{

    GPIO_InitTypeDef GPIO_InitStructure;
# 98 "./src/main/vcp/hw_config.c"
    ...
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x1000));

    delay(200);

    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x1000));
# 130 "./src/main/vcp/hw_config.c"
    RCC_APB2PeriphClockCmd(((uint32_t)0x00000004), ENABLE);
...
# 348 "./src/main/vcp/hw_config.c"
uint8_t usbIsConfigured(void)
{
    return (bDeviceState == CONFIGURED);
}
# 360 "./src/main/vcp/hw_config.c"
uint8_t usbIsConnected(void)
{
