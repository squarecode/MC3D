 ...
 */
 ...
 //MC3D config by Stefan Voigt 2017
 #define FAKE_BOARD

#define TARGET_BOARD_IDENTIFIER "CC3D" // MC3D

#define LED0                    PC13

//Lets fake the MC3D Board for the STM32 Mini Devboard
#ifdef FAKE_BOARD
    #define ACC
    #define USE_FAKE_ACC
...
#define TARGET_IO_PORTC         ( BIT(14) | BIT(13) )
